...
dotnet test -c Release --no-build --collect:"XPlat Code Coverage" --settings coverletArgs.runsettings --filter "FullyQualifiedName!~Aguacongas.IdentityServer.MongoDb.Store.Test" -v q
