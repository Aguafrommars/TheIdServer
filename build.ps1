...
dotnet test -c Release --no-build --collect:"XPlat Code Coverage" --settings coverletArgs.runsettings --filter "FullyQualifiedName!~Pages & FullyQualifiedName!~MongoDb" -v q
