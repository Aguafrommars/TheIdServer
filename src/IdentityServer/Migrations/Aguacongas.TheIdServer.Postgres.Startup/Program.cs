...
namespace Aguacongas.TheIdServer.Postgres
{
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    Action<DbContextOptionsBuilder> optionsAction = options => options.UseNpgsql(cn, options => options.MigrationsAssembly("Aguacongas.TheIdServer.Postgres"));
